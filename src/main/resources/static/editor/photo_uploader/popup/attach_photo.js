    ...
    function html5Upload() {	
    	...
    	sUploadURL= '/board/multiplePhotoUpload.do';//'file_uploader_html5.php'; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : '/board/photoUpload.do',//location.href.replace(/\/[^\/]*$/, '') + '/file_uploader.php',	//샘플 URL입니다.
 	        sCallback : '/resources/editor/photo_uploader/popup/callback.html', //location.href.replace(/\/[^\/]*$/, '') + '/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
